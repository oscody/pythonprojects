...
def schedule_alarm(alarm_time, alarm_message, duration=30):
    ...
    return alarm_timer , delay

# Schedule an alarm
alarm_time = "11:57 PM"  # Correctly using AM/PM notation
alarm_message = "Time to wake up!"
alarm_timer , delay = schedule_alarm(alarm_time, alarm_message, duration=30)  # Plays for 30 seconds

print(f"alarm_timer: {alarm_timer}")
